(function () {
    'use strict';
    calendarApp.provider('googleClient', function () {
        let clientId;
        let scopes = '';
        ...
        let loadClient = false;
        let loadPicker = false;
        let loadGoogleSignIn = false;

        let apiLoadingPromise;
        let apiLoaded = false;
        ...
        const apiLoadCallback = function () {
            if (--apisToLoad === 0) {
                apiLoaded = true;
                apiLoading = false;
        ...
        const scriptsLoadCallback = function () {
            if (--scriptsToLoad === 0) {
                scriptsLoaded = true;
        ...
        const loadClientLibrary = function () {
            if (!loadClient) {
                loadClient = true;
                scriptsToLoad++;
            }

...
calendarApp.config(function (googleClientProvider) {
...
calendarApp.component('leftPanel', {
    templateUrl: 'js/leftPanel/leftPanel.template.html',
});
calendarApp.controller("LeftPanelController", function ($scope, $element, $attrs, googleClient, cmAuthService, cmApiService) {
    console.log("element", $element);
    console.log("authService", cmAuthService);
    console.log("apiService", cmApiService);
